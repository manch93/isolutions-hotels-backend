...
Route::group([
    ...
    Route::get('/master/content', App\Livewire\Cms\Master\Content::class)->name('master.content');
    Route::get('/master/content-item', App\Livewire\Cms\Master\ContentItem::class)->name('master.content-item');
